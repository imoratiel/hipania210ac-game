...
BEGIN
    ...
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Centurión', 'Centurión', 'Centuria',    100,  150,  3, r2,   1, cid) RETURNING id INTO r3;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Prefecto',  'Prefecta',  'Prefectura',  250,  400,  4, r3,   1, cid) RETURNING id INTO r4;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Legatus',   'Legata',    'Legatio',     500,  600,  5, r4,   1, cid) RETURNING id INTO r5;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Consul',    'Consul',    'Consulado',   1000, NULL, 6, r5,   1, cid);
END$$;
...
BEGIN
    ...
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Capitán de Flota',  'Capitana de Flota', 'Flota',        100,  150,  3, r2,   1, cid) RETURNING id INTO r3;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Comandante',        'Comandante',        'Comandancia',  250,  400,  4, r3,   1, cid) RETURNING id INTO r4;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Estratego',         'Estratega',         'Estrategia',   500,  600,  5, r4,   1, cid) RETURNING id INTO r5;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Sufete',            'Sufete',            'Sufetado',     1000, NULL, 6, r5,   1, cid);
END$$;
...
BEGIN
    ...
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Clan Jefe',       'Clan Jefa',       'Dominio del Clan',   100,  150,  3, r2,   1, cid) RETURNING id INTO r3;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Régulo',          'Régula',          'Régulo',             250,  400,  4, r3,   1, cid) RETURNING id INTO r4;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Gran Caudillo',   'Gran Caudilla',   'Gran Caudillaje',    500,  600,  5, r4,   1, cid) RETURNING id INTO r5;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Rey de Reyes',    'Reina de Reinas', 'Reino Supremo',      1000, NULL, 6, r5,   1, cid);
END$$;
...
BEGIN
    ...
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Vate/Druida Menor',     'Vate/Druida Menor',       'Cantón Druídico',  250,  400,  4, r3,   1, cid) RETURNING id INTO r4;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Vergobretus',           'Vergobretra',             'Vergobrecia',      500,  600,  5, r4,   1, cid) RETURNING id INTO r5;
    INSERT INTO noble_ranks (title_male, title_female, territory_name, min_fiefs_required, max_fiefs_limit, level_order, required_parent_rank_id, required_count, culture_id)
    VALUES ('Archidruida/Gran Rey',  'Gran Druidesa/Gran Reina','Gran Druidiato',   1000, NULL, 6, r5,   1, cid);
END$$;
