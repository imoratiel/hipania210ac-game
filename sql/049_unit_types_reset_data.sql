...
('Hastati',        7, 6, 5,  3, 20, 2,   6, 1, 120,  FALSE, 'Base de la legión.',         1, 'INFANTRY_1'),
('Triarii',        6, 9, 7,  2, 30, 2,  15, 1, 300,  FALSE, 'Muy caros, pero el muro final.', 1, 'INFANTRY_2'),
('Equites',        4, 4, 6,  5, 20, 5,   5, 2, 100,  FALSE, 'Movilidad básica.',           1, 'CAVALRY_1'),
('Auxilia',  7, 6, 7,  4, 20, 4,   9, 2, 180,  FALSE, 'Versatilidad aliada.',        1, 'CAVALRY_2'),
('Velites',        8, 3, 4,  3, 20, 3,   4, 1,  90,  FALSE, 'Hostigadores baratos.',       1, 'ARCHER_1'),
...
('Onagro',         1, 1, 1,  1,100, 1, 250, 1, 1200, TRUE,  'Pieza tecnológica lenta.',    1, 'SIEGE');

-- ══════════════════════════════════════════════════════════════════════════════
-- CARTAGO  (culture_id = 2)
-- ══════════════════════════════════════════════════════════════════════════════
INSERT INTO unit_types (name, attack, defense, health_points, speed, initial_experience, detection_range, gold_upkeep, food_consumption, recruit_cost, is_siege, descrip, culture_id, unit_class) VALUES
('Infantería Libia',          7, 7, 5,  3, 20, 2,   7, 1, 150,  FALSE, 'Infantería profesional.',       2, 'INFANTRY_1'),
('Mercenarios Galos',         9, 4, 6,  4, 50, 2,  20, 1, 400,  FALSE, 'Reclutamiento instantáneo.',    2, 'INFANTRY_2'),
('Caballería Numida',   5, 3, 6,  7, 20, 5,   5, 2, 100,  FALSE, 'Maestros del mapa H3.',         2, 'CAVALRY_1'),
...
('Elefantes',          12, 8, 30, 3, 20, 3,  50, 4, 1200, FALSE, 'Consumo masivo de comida.',     2, 'INFANTRY_ELITE'),
('Ariete',              1, 1, 1,  1,100, 1, 250, 1, 1200, TRUE,  'Asedio protegido.',             2, 'SIEGE');

-- ══════════════════════════════════════════════════════════════════════════════
-- ÍBEROS  (culture_id = 3)
-- ══════════════════════════════════════════════════════════════════════════════
INSERT INTO unit_types (name, attack, defense, health_points, speed, initial_experience, detection_range, gold_upkeep, food_consumption, recruit_cost, is_siege, descrip, culture_id, unit_class) VALUES
('Caetrati',    6, 5, 5, 5, 20, 2,  5, 1, 100,  FALSE, 'Guerrilla barata.',       3, 'INFANTRY_1'),
('Scutarii',    8, 5, 6, 4, 20, 2,  7, 1, 150,  FALSE, 'Crítico con Falcata.',    3, 'INFANTRY_2'),
('Jinetes con Lanza',  6, 4, 6, 6, 20, 5,  6, 2, 120,  FALSE, 'Golpe y fuga.',           3, 'CAVALRY_1'),
...
('Devotio',     8, 8, 7, 4, 60, 2,  0, 1, 900,  FALSE, 'Tan leales que no cobran soldadas.', 3, 'INFANTRY_ELITE'),
...
-- ══════════════════════════════════════════════════════════════════════════════
INSERT INTO unit_types (name, attack, defense, health_points, speed, initial_experience, detection_range, gold_upkeep, food_consumption, recruit_cost, is_siege, descrip, culture_id, unit_class) VALUES
('Celtíberos',               8, 6, 5,  3, 20, 2,  7, 1, 140,  FALSE, 'Duros y feroces.',         4, 'INFANTRY_1'),
('Lanceros del Norte',       5, 8, 6,  2, 20, 2,  7, 1, 150,  FALSE, 'Muro de escudos.',         4, 'INFANTRY_2'),
...
('Caballería Exploración',      4, 3, 5,  6, 20, 5,  4, 2,  70,  FALSE, 'Visión en el mapa.',       4, 'CAVALRY_1'),
